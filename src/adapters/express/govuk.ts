 ...
 */
export function setupGovUKFrontend(app: Express, nunjucksEnv: nunjucks.Environment) {
  ...
  nunjucksEnv.addGlobal('govukComponentsPath', join(process.cwd(), 'node_modules', 'govuk-frontend', 'dist', 'govuk', 'components'));
