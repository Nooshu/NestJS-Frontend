 ...
 * This module provides rate limiting and other security features via NestJS throttler.
...
@Module({
  ...
  providers: [SecurityConfig, SecurityErrorFilter],
  exports: [SecurityConfig, SecurityErrorFilter],
})
